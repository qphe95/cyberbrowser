...
(function() {
  ...
  (function(y, v) {
      ...
      typeof p != "number" || isNaN(p) ? p !== void 0 && Object.getOwnPropertyNames(p).forEach(function(B) {
        if (p[B] !=
          ...
          if (typeof A[B] == "number" || B == "duration")
            if (typeof p[B] != "number" || isNaN(p[B])) return;
    ...
    function d(p, w, z, A) {
      return p < 0 || p > 1 || z < 0 || z > 1 ? n : function(B) {
        ...
        if (B >= 1) return D = 0, z < 1 ? D = (A - 1) / (z - 1) : z == 1 && p < 1 && (D = (w -
          1) / (p - 1)), 1 + D * (B - 1);
        D = 0;
        for (var H = 1; D < H;) {
          var E = (D + H) / 2,
            M = 3 * p * (1 - E) * (1 - E) * E + 3 * z * (1 - E) * E * E + E * E * E;
          if (Math.abs(B - M) < 1E-5) break;
          M < B ? D = E : H = E
        }
    ...
    k.prototype = {
      _setMember: function(p, w) {
        this["_" + p] = w;
        this._effect && (this._effect._timingInput[p] = w, this._effect._timing =
          y.normalizeTimingInput(this._effect._timingInput), this._effect.activeDuration = y.calculateActiveDuration(this._effect._timing), this._effect._animation && this._effect._animation._rebuildUnderlyingAnimation())
      },
      get playbackRate() {
      ...
      set iterationStart(p) {
        if ((isNaN(p) ||
            p < 0) && f()) throw new TypeError("iterationStart must be a non-negative number, received: " + p);
      ...
      set duration(p) {
        if (p != "auto" && (isNaN(p) || p < 0) && f()) throw new TypeError("duration must be non-negative or auto, received: " + p);
      ...
      set iterations(p) {
        if ((isNaN(p) || p < 0) && f()) throw new TypeError("iterations must be non-negative, received: " + p);
    ...
    y.calculateIterationProgress = function(p, w, z) {
      ...
      p = B;
      B = A === 2 && z.iterations === Infinity ? Infinity : p === 1 ? Math.floor(w) -
        1 : Math.floor(w);
      w = A = z.direction;
      A !== "normal" && A !== "reverse" && (A === "alternate-reverse" && (B += 1), w = "normal", B !== Infinity && B % 2 !== 0 && (w = "reverse"));
    ...
    function k(a) {
      ...
      for (b in a)
        if (!(b in ["easing", "offset", "composite"])) {
          var g = a[b];
          Array.isArray(g) || (g = [g]);
          for (var e, m = g.length, n = 0; n < m; n++) e = {}, e.offset = "offset" in a ? a.offset : m == 1 ? 1 : n / (m - 1), "easing" in a && (e.easing =
            a.easing), "composite" in a && (e.composite = a.composite), e[b] = g[n], c.push(e)
        } c.sort(function(l, r) {
        ...
        for (r in n) {
          ...
          if (r == "offset") {
            if (t != null) {
              ...
              if (t < 0 || t > 1) throw new TypeError("Keyframe offsets must be between 0 and 1.");
            }
          } else if (r ==
            "composite") {
            if (t == "add" || t == "accumulate") throw {
              type: DOMException.NOT_SUPPORTED_ERR,
              name: "NotSupportedError",
              message: "add compositing is not supported"
            };
            if (t != "replace") throw new TypeError("Invalid composite mode " + t + ".");
          } else t = r == "easing" ? y.normalizeEasing(t) : "" + t;
          var x = void 0,
            u = r,
            q = t;
          t = l;
          ...
          if (C !== "display" && C.lastIndexOf("animation", 0) !== 0 && C.lastIndexOf("transition", 0) !== 0)
            if (C = f[u])
              for (x in h.style[u] = q, C) {
                q = u = C[x];
                var p = h.style[u];
                t[u] = q in d ? d[q][p] || p : p
              } else t[u] = u in d ? d[u][q] || q :
                q
        }
  ...
  (function(y) {
    ...
    y.isDeprecated = function(k, f, h, d) {
      ...
      return a < f ? (k in v ||
        console.warn("Web Animations: " + k + " " + d + " deprecated and will stop working on " + f.toDateString() + ". " + h), v[k] = !0, !1) : !0
    };
  ...
  (function() {
    if (document.documentElement.animate) {
      ...
      function d(c) {
        for (var b = {}, g = 0; g < c.length; g++)
          ...
          if (c = b[n], c[0].offset != 0 || c[c.length - 1].offset != 1) throw {
            type: DOMException.NOT_SUPPORTED_ERR,
            name: "NotSupportedError",
        ...
        for (g in c)
          for (var e = c[g], m = 0; m < e.length - 1; m++) {
            var n = m,
              ...
              x = r,
              u = t;
            m == 0 && (x = -Infinity, t == 0 && (l = n));
            m == e.length - 2 && (u = Infinity, r == 1 && (n = l));
            b.push({
              applyFrom: x,
              applyTo: u,
      ...
      f.convertEffectInput = function(c) {
        ...
        var b = d(c),
          g = a(b);
        return function(e, m) {
          if (m != null) g.filter(function(l) {
            return m >= l.applyFrom &&
              m < l.applyTo
          }).forEach(function(l) {
            ...
            for (var n in b) n != "offset" && n != "easing" && n != "composite" && f.clear(e, n)
        }
      }
    })(G, F, null);
    (function(k, f, h) {
      ...
      f.propertyInterpolation = function(b, g, e) {
        ...
        if (g == "initial" || e == "initial") g == "initial" && (g = c[m]), e == "initial" && (e = c[m]);
        b = g == e ? [] : a[m];
    ...
    (function(k, f) {
      function h(d, a, c) {
        if (typeof d == "number" && typeof a == "number") return d * (1 - c) + a * c;
        if (typeof d == "boolean" && typeof a == "boolean") return c < .5 ? d : a;
        if (d.length == a.length) {
          for (var b = [], g = 0; g < d.length; g++) b.push(h(d[g], a[g], c));
          return b
        }
        throw "Mismatched interpolation arguments " +
          d + ":" + a;
      }
    ...
    (function(k, f, h) {
      ...
      f.Animation.prototype = {
        ...
        _tickCurrentTime: function(a,
          c) {
          a != this._currentTime && (this._currentTime = a, this._isFinished && !c && (this._currentTime = this._playbackRate > 0 ? this._totalDuration : 0), this._ensureAlive())
        },
        get currentTime() {
        ...
        set currentTime(a) {
          a = +a;
          isNaN(a) || (f.restart(), this._paused || this._startTime == null || (this._startTime = this._timeline.currentTime - a / this._playbackRate), this._currentTimePending = !1, this._currentTime != a && (this._idle && (this._idle = !1, this._paused = !0), this._tickCurrentTime(a,
            !0), f.applyDirtiedAnimation(this)))
        },
        get startTime() {
        ...
        set playbackRate(a) {
          if (a != this._playbackRate) {
            ...
            this._startTime = null;
            this.playState != "paused" && this.playState != "idle" && (this._idle = this._finishedFlag = !1, this._ensureAlive(), f.applyDirtiedAnimation(this));
        ...
        _rewind: function() {
          if (this._playbackRate >=
            0) this._currentTime = 0;
          else if (this._totalDuration < Infinity) this._currentTime = this._totalDuration;
          else throw new DOMException("Unable to rewind negative playback rate animation with infinite duration", "InvalidStateError");
        },
        play: function() {
          this._paused = !1;
        ...
        finish: function() {
          this._idle || (this.currentTime = this._playbackRate > 0 ? this._totalDuration : 0, this._startTime = this._totalDuration - this.currentTime, this._currentTimePending = !1, f.applyDirtiedAnimation(this))
        },
        cancel: function() {
        ...
        removeEventListener: function(a, c) {
          a == "finish" && (a = this._finishHandlers.indexOf(c), a >= 0 && this._finishHandlers.splice(a, 1))
        },
    ...
    (function(k, f, h) {
      ...
      function c() {
        this._animations = [];
        this.currentTime = window.performance && performance.now ? performance.now() :
          0
      }
      ...
      f.applyDirtiedAnimation = function(q) {
        x || (q._markTarget(),
          q = q._targetAnimations(), q.sort(a), g(f.timeline.currentTime, !1, q.slice())[1].forEach(function(C) {
    ...
    (function(k) {
      ...
      k.consumeParenthesised = function(c, b) {
        for (var g = 0, e = 0; e < b.length &&
          (!/\s|,/.test(b[e]) || g != 0); e++)
          if (b[e] == "(") g++;
          else if (b[e] == ")" && (g--, g == 0 && e++, g <= 0)) break;
        c = c(b.substr(0, e));
      ...
      k.mergeNestedRepeated = a.bind(null,
        null);
    ...
    (function(k, f) {
      ...
      k.addPropertiesHandler(a, function(g, e) {
        if (g != 0) return c(0, Infinity)(g, e)
    ...
    (function(k, f) {
      k.addPropertiesHandler(String, function(h, d) {
        if (h == "visible" || d == "visible") return [0, 1, function(a) {
    ...
    (function(k, f) {
      ...
      function d(c, b) {
        return [c, b, function(g) {
          if (g[3])
            for (var e = 0; e < 3; e++) g[e] = Math.round(Math.max(0, Math.min(255, g[e] / g[3])));
    ...
    (function(k, f) {
      ...
      function d(m,
        ...
        if (/^[^(]*$|^calc/.test(n)) {
          ...
          if (r == "D") {
            for (var u in l) {
              r = h(n.replace(new RegExp("U" +
                u, "g"), "").replace(new RegExp(m, "g"), "*0"));
      ...
      function c(m, n, l) {
        var r = [],
          t;
        for (t in m) r.push(t);
        for (t in n) r.indexOf(t) < 0 && r.push(t);
        m = r.map(function(x) {
          return m[x] || 0
        });
        n = r.map(function(x) {
      ...
      var b = d.bind(null, RegExp("px|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc",
        "g"));
    ...
    (function(k, f) {
      ...
      function d(a) {
        if ((a = k.consumeList([k.ignore(k.consumeToken.bind(null, /^rect/)), k.ignore(k.consumeToken.bind(null, /^\(/)), k.consumeRepeated.bind(null, h, /^,/), k.ignore(k.consumeToken.bind(null, /^\)/))], a)) && a[0].length == 4) return a[0]
      }
    ...
    (function(k, f) {
      ...
      function a(l) {
        ...
        if (l == "none") return [];
        for (var r = /\s*(\w+)\(([^)]*)\)/g, t = [], x, u = 0;
          (x = r.exec(l)) && x.index == u;) {
        ...
        if (l.length != r.length) {
          ...
          for (u = 0; u < l.length; u++) {
            ...
            if (q == "perspective" && B == "perspective" || !(q != "matrix" && q != "matrix3d" || B != "matrix" && B != "matrix3d")) {
              ...
              if (q != B)
                if (A[2] && E[2] && q.replace(/[xy]/, "") == B.replace(/[xy]/, "")) q = q.replace(/[xy]/, ""), D = A[2](D), H = E[2](H);
                else if (A[1] && E[1] && g(q) == g(B)) q = g(q), D = A[1](D), H = E[1](H);
              else {
                if (!t) return;
                A = b(l, r);
                C = [A[0]];
              ...
              E = [];
              B = [];
              for (var M = [], K = 0; K < D.length; K++) A = (typeof D[K] == "number" ? k.mergeNumbers : k.mergeDimensions)(D[K], H[K]), E[K] = A[0], B[K] = A[1], M.push(A[2]);
              C.push(E);
              w.push(B);
              z.push([q, M])
            }
    ...
    (function(k, f) {
      function h(c, b) {
        b.concat([c]).forEach(function(g) {
          g in document.documentElement.style &&
            (d[c] = g);
          a[g] = c
        })
      }
    ...
    if (document.createElement("div").animate([]).oncancel === void 0) {
      ...
      window.Element.prototype.animate = function(f, h) {
        ...
        f.removeEventListener = function(b, g) {
          b == "cancel" ? (b = this._cancelHandlers.indexOf(g), b >= 0 && this._cancelHandlers.splice(b, 1)) : c.call(this, b, g)
        };
        return f
      }
    }
  ...
  (function(y) {
    var v = document.documentElement,
      ...
      f = !1;
    try {
      var h = getComputedStyle(v).getPropertyValue("opacity") ==
        "0" ? "1" : "0";
      k = v.animate({
        opacity: [h, h]
      }, {
    ...
    v.Animation.prototype = {
      _updatePromises: function() {
        var f = this._oldPlayState,
          h = this.playState;
        this._readyPromise && h !== f && (h == "idle" ? (this._rejectReadyPromise(), this._readyPromise = void 0) : f == "pending" ? this._resolveReadyPromise() : h == "pending" && (this._readyPromise = void 0));
      ...
      _rebuildUnderlyingAnimation: function() {
        ...
        f && (h != 1 && (this.playbackRate = h), a !== null ? this.startTime = a : c !== null ? this.currentTime = c : this._holdTime !== null && (this.currentTime = this._holdTime), d && this.pause());
        this._updatePromises()
      },
      ...
      _setExternalAnimation: function(f) {
        if (this.effect && this._isGroup)
          for (var h = 0; h < this.effect.children.length; h++) this.effect.children[h]._animation = f, this._childAnimations[h]._setExternalAnimation(f)
      },
      ...
      _arrangeChildren: function(f, h) {
        this.startTime === null ? f.currentTime = this.currentTime - h / this.playbackRate : f.startTime !==
      ...
      get finished() {
        ...
        this._finishedPromise || (v.animationsWithPromises.indexOf(this) == -1 && v.animationsWithPromises.push(this), this._finishedPromise = new Promise(function(f, h) {
        ...
        }.bind(this)), this.playState == "finished" && this._resolveFinishedPromise());
        return this._finishedPromise
      },
      get ready() {
        if (!window.Promise) return console.warn("Animation Promises require JavaScript Promise constructor"), null;
        this._readyPromise || (v.animationsWithPromises.indexOf(this) == -1 && v.animationsWithPromises.push(this), this._readyPromise = new Promise(function(f, h) {
        ...
        }.bind(this)), this.playState !== "pending" && this._resolveReadyPromise());
      ...
      set oncancel(f) {
        this._animation.oncancel = typeof f ==
          "function" ? function(h) {
            h = Object.create(h);
            Object.defineProperty(h, "target", {
              value: this
      ...
      play: function() {
        ...
        this._timeline._animations.indexOf(this) ==
          -1 && this._timeline._animations.push(this);
        this._register();
  ...
  (function(y, v, k) {
    ...
    var d = function(e) {
      ...
      if (e instanceof window.SequenceEffect || e instanceof window.GroupEffect)
        for (var m =
            0; m < e.children.length; m++) d(e.children[m])
    };
    v.removeMulti = function(e) {
      for (var m = [], n = 0; n < e.length; n++) {
        var l = e[n];
        l._parent ? (m.indexOf(l._parent) == -1 && m.push(l._parent), l._parent.children.splice(l._parent.children.indexOf(l), 1), l._parent = null, d(l)) : l._animation && l._animation.effect == l && (l._animation.cancel(), l._animation.effect = new KeyframeEffect(null, []), l._animation._callback && (l._animation._callback._animation = null), l._animation._rebuildUnderlyingAnimation(), d(l))
      }
    ...
    v.KeyframeEffect = function(e, m, n, l) {
      ...
      typeof m == "function" ? (y.deprecated("Custom KeyframeEffect", "2015-06-22", "Use KeyframeEffect.onsample instead."), this._normalizedKeyframes = m) : this._normalizedKeyframes = new f(m);
      this._keyframes = m;
    ...
    v.KeyframeEffect.prototype = {
      ...
      set onsample(e) {
        if (typeof this.getFrames() == "function") throw Error("Setting onsample on custom effect KeyframeEffect is not supported.");
        this._onsample = e;
      ...
      clone: function() {
        if (typeof this.getFrames() == "function") throw Error("Cloning custom effects is not supported.");
    ...
    v.awaitStartTime = function(e) {
      e.startTime === null && e._isGroup && (b.length == 0 && requestAnimationFrame(h), b.push(e))
    };
  ...
  (function(y, v, k) {
    ...
    v.bindAnimationForCustomEffect = function(b) {
      ...
      var r = function() {
        ...
        t !== null && (t = y.calculateIterationProgress(y.calculateActiveDuration(n), t, n), isNaN(t) && (t = null));
  ...
  (function(y, v, k) {
    function f(d) {
      return d._timing.delay +
        d.activeDuration + d._timing.endDelay
    }
    ...
    h.prototype = {
      ...
      _rebuild: function() {
        for (var d = this; d;) d.timing.duration === "auto" && (d._timing.duration = d.activeDuration), d = d._parent;
        this._animation && this._animation._rebuildUnderlyingAnimation()
      },
      ...
      clone: function() {
        for (var d = y.cloneTimingInput(this._timingInput),
            a = [], c = 0; c < this.children.length; c++) a.push(this.children[c].clone());
    ...
    Object.defineProperty(window.GroupEffect.prototype,
      "activeDuration", {
        get: function() {
          var d = 0;
          this.children.forEach(function(a) {
    ...
    v.newUnderlyingAnimationForGroup = function(d) {
      ...
      d.onsample = function(b) {
        var g = a._wrapper;
        g && g.playState != "pending" && g.effect && (b == null ? g._removeChildAnimations() : b == 0 && g.playbackRate < 0 && (c || (c = y.normalizeTimingInput(g.effect.timing)), b = y.calculateIterationProgress(y.calculateActiveDuration(c), -1, c), isNaN(b) || b == null) && (g._forEachChild(function(e) {
          e.currentTime = -1
