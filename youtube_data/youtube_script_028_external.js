(function() {
  ...
  */
  ...
  function va(a, b) {
    if (a.nodeType === 1) {
      var c = a.tagName;
      if (/^(script|style)$/i.test(c)) throw a = c.toLowerCase() === "script" ? "Use setScriptTextContent with a SafeScript." : "Use setStyleTextContent with a SafeStyleSheet.", Error(a);
    }
  ...
  function hb(a, b) {
    var c = K[a];
    if (c && (lb(c), c.H > 0 && c.items.length)) {
      var d = c.items[0];
      d && (a = n(function(e, f) {
        f();
        e()
      }, null, n(hb, null, a, b)), b ? (c.items.shift(), a(d.K)) : mb(c, d, a))
    }
  }

  function mb(a, b, c) {
    b.delay ? (c = n(c, null, Aa), a.A = setTimeout(c, b.delay), b.delay = 0) : (a.items.shift(), c = n(c, null, b.K), (b = (b = A["advanced-task-scheduler"]) && b.addTask) ? a.B = b(c) : a.A = setTimeout(c, 0))
  }
  ...
  */
  ...
  function ub(a, b, c, d, e, f) {
    ...
    h ? (m.async = !0, ua(m, ya(b)), d.insertBefore(m, d.firstChild)) : (m.rel =
  ...
  */
  ...
  function V(a, b, c, d) {
    ...
    var I = b.body || {},
      bd = u,
      Ua;
    for (Ua in I) u = n(function(t, C) {
      if (t = document.getElementById(t)) {
        !e || g || h || (w("nav-scroll-position", null), w("nav-scroll-url", null), window.scroll(0, 0), h = !0, c && (c.o = !0));
        var H = W(C);
        Zb(H);
        var M = function() {
          ib(m);
  ...
  function dc(a) {
    ...
    a.u.className = a.W;
    va(a.u, wa(a.V));
    a.reverse ? (b = a.v, b.parentNode.insertBefore(a.u, b)) : (b = a.v, b.parentNode.insertBefore(a.u, b.nextSibling))
  }
  ...
  function W(a) {
    ...
    a = a.replace(lc, function(c, d, e, f) {
      ...
      return d == "style" && (d = (d = e.match(mc)) ? d[1] : "", e = pc.exec(e), e = !e || e[1].indexOf("text/css") != -1) ? (b.styles.push({
        url: "",
        text: f,
        name: d
      }), "") : c
    ...
    a = a.replace(qc, function(c, d) {
      var e = d.match(rc);
      e = e ? e[1] : "";
      return e == "stylesheet" ? (e = (e = d.match(mc)) ? e[1] : "", d = (d = d.match(sc)) ? d[1] : "", b.styles.push({
        url: d,
        text: "",
        name: e
      }), "") : e == "spf-preconnect" ? (d = (d = d.match(sc)) ? d[1] : "", b.links.push({
        url: d,
        rel: e
      }), "") : c
    });
  ...
  function tc(a, b, c, d) {
    ...
    k.onreadystatechange = function() {
      ...
      if (k.readyState == 2) {
        ...
        e.P && e.P(k)
      } else k.readyState == 3 ? f && e.D && (u = k.responseText.substring(g), g = k.responseText.length, e.D(k, u)) : k.readyState == 4 && (u.responseEnd = u.responseEnd || q(), window.performance && window.performance.getEntriesByName && (k.resourceTiming = window.performance.getEntriesByName(b).pop()), f && e.D && k.responseText.length > g && (u = k.responseText.substring(g), g = k.responseText.length, e.D(k, u)), clearTimeout(h), e.O && e.O(k))
    };
  ...
  function uc(a, b) {
    ...
    return b.method == "POST" ? tc("POST", d, b.I, a) : tc("GET", d,
      null, a)
  }
  ...
  function zc(a, b, c, d, e) {
    ...
    if (b.m && k.length > 1)
      for (d = d.complete.length; d < k.length; d++) e = k[d], e.timing || (e.timing = {}), e.timing.spfCached = !!c.spfCached, e.timing.spfPrefetched = !!c.spfPrefetched, b.m(a, e);
    if (k.length > 1) {
      var m;
      r(k, function(B) {
  ...
  function Kc(a) {
    if (!a.defaultPrevented) {
      var b = Gc(a);
      b && (b = pb(b), Hc(b) && Ic() && p("spfclick", {
        url: b,
        target: a.target
      }) && (Lc(b, {}, new Mc), a.preventDefault()))
    }
  }
  ...
  function Rc(a, b) {
    ...
    Hc(a) ? Ic() ? p("spfhistory", {
      ...
      referer: b.i,
      previous: b.current
    }) && (b.position && (w("nav-scroll-position", [window.pageXOffset, window.pageYOffset]), w("nav-scroll-url", window.location.href)), Lc(a, {}, b)) : X(a, "1") : X(a, "9")
  }
  ...
  function Lc(a, b, c) {
    ...
    if (Jc(a, c.current))
      if (Tc(a, c.i, c.current, b)) {
        ...
        if (d && d.readyState != 4) d = "preprocess " + N(a), e = "promote " + N(a), w("nav-promote", a), w("nav-promote-time", q()), kb(d), L(e, !0), c.history || Wc(a, c.i, n(Y, null, b));
        else {
          d = n(Y, null, b);
          e = n(Xc, null, b, c);
          var f = n(Yc, null,
    ...
    else c.history || Wc(a, c.i, n(Y, null, b)), $c(a, c)
  }

  function $c(a, b) {
    if (b.position) Qc(), window.scroll.apply(null, b.position), b.o = !0;
    else if (a = z(a, "#"), a[2]) {
      if (a = document.getElementById(a[2])) Qc(), a.scrollIntoView(), b.o = !0
    } else b.o || (Qc(), window.scroll(0, 0), b.o = !0)
  }
  ...
  function Xc(a, b, c, d) {
    if (cd(c, d, a))
      if (d.reload) X(c, "5");
      else if (d.redirect) dd(a, d.redirect);
    else try {
      V(c, d, b, function() {
        ed(c, d, a)
      })
  ...
  function jd(a, b, c, d, e) {
    if (cd(d, e, b, !0)) {
      ...
      if (e.redirect) nd(a, b, c, e.redirect);
      else {
        if (a) {
  ...
  var qd = {
      ...
      navigate: function(a, b) {
        a && (a = pb(a), Hc(a) ? Ic() ? Lc(a, b || {}, new Mc) : X(a, "1") : X(a, "9"))
      },
      load: function(a, b) {
        a = pb(a);
        hd(a, b || {}, new Mc)
  ...
  var sd = l.spf,
    td;
  for (td in qd) sd[td] = qd[td];
  for (var ud in rd)
    for (var vd in rd[ud]) sd[ud] = sd[ud] || {}, sd[ud][vd] = rd[ud][vd];
  p("spfready");
}).call(this);