...
(function(f, h) {
  ...
  function d(a, b) {
    b = b || {};
    if (typeof a != "function") throw Error("callback must be a function");
    if (b.root && b.root.nodeType != 1) throw Error("root must be an Element");
  ...
  function v(a, b, c, e) {
    typeof a.removeEventListener ==
      "function" ? a.removeEventListener(b, c, e || !1) : typeof a.P == "function" && a.P("on" + b, c)
  }
  ...
  if ("IntersectionObserver" in
    f && "IntersectionObserverEntry" in f && "intersectionRatio" in f.IntersectionObserverEntry.prototype) "isIntersecting" in f.IntersectionObserverEntry.prototype || Object.defineProperty(f.IntersectionObserverEntry.prototype, "isIntersecting", {
    get: function() {
    ...
    d.prototype.observe = function(a) {
      if (!this.h.some(function(b) {
        ...
        if (!a || a.nodeType != 1) throw Error("target must be an Element");
        this.M();
        this.h.push({
          element: a,
          entry: null
    ...
    d.prototype.F = function(a, b) {
      if (f.getComputedStyle(a).display != "none") {
        ...
        for (var e = !1; !e;) {
          ...
          if (k.display == "none") return;
          a == this.root || a == h ? (e = !0, g = b) : a != h.body && a != h.documentElement && k.overflow != "visible" && (g = m(a));
          if (g) {
    ...
    d.prototype.H = function() {
      if (this.root) var a = m(this.root);
      else {
        a = h.documentElement;
        var b = h.body;
        a = {
    ...
    d.prototype.G = function(a) {
      var b = this.u.map(function(c, e) {
        return c.unit == "px" ? c.value :
          c.value * (e % 2 ? a.width : a.height) / 100
      });
      b = {
        top: a.top - b[0],
        right: a.right + b[1],
